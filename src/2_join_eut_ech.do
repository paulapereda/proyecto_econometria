...
/* Me quedo únicamente con los que efectivamente se mergearon */

keep if _merge == 3

/* Me quedo con aquellos cuya relación de parentesco es o jefe o cónyuge */ 
...
/* ¡Mil gracias a Horacio Rueda por la ayuda! */
